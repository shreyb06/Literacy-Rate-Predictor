# -*- coding: utf-8 -*-
"""
Created on Fri Nov 24 12:50:52 2023
...
colored_header(
    ...
    description = "Please note that the model may not be 100 percent accurate.",
...
if (prediction_button):
    if (not predict_region or not select_country or not select_year or not select_age or not select_biological):
        ...
        if (final_predicted_value >= 1): 
            ...
            st.success("Predicted literacy rate: " + str(final_predicted_percent[0]) + "% literacy rate")
